...
fn print_field_json(field: &gribtract::Field, include_values: bool) {
    ...
    println!(
        "{}  \"discipline\": {},",
        indent, field.parameter.discipline
    );
    ...
    println!(
        "{}  \"scale_factor1\": {},",
        indent, field.level.scale_factor1
    );
    println!(
        "{}  \"scaled_value1\": {},",
        indent, field.level.scaled_value1
    );
    println!("{}  \"type2\": {},", indent, field.level.type2);
    println!(
        "{}  \"scale_factor2\": {},",
        indent, field.level.scale_factor2
    );
    println!(
        "{}  \"scaled_value2\": {},",
        indent, field.level.scaled_value2
    );
    ...
    println!(
        "{}    \"year\": {},",
        indent, field.forecast.reference_time.year
    );
    println!(
        "{}    \"month\": {},",
        indent, field.forecast.reference_time.month
    );
    println!(
        "{}    \"day\": {},",
        indent, field.forecast.reference_time.day
    );
    println!(
        "{}    \"hour\": {},",
        indent, field.forecast.reference_time.hour
    );
    println!(
        "{}    \"minute\": {},",
        indent, field.forecast.reference_time.minute
    );
    println!(
        "{}    \"second\": {},",
        indent, field.forecast.reference_time.second
    );
    println!(
        "{}    \"significance\": {},",
        indent, field.forecast.reference_time.significance
    );
    println!(
        "{}    \"unix_seconds\": {}",
        indent,
        field.forecast.reference_time.unix_seconds()
    );
    println!("{}  }},", indent);
    println!(
        "{}  \"time_range_unit\": {},",
        indent, field.forecast.time_range_unit
    );
    println!(
        "{}  \"forecast_offset\": {},",
        indent, field.forecast.forecast_offset
    );
    println!(
        "{}  \"offset_seconds\": {},",
        indent,
        field.forecast.offset_seconds()
    );
    println!(
        "{}  \"valid_unix_seconds\": {}",
        indent,
        field.forecast.valid_unix_seconds()
    );
    println!("{}}},", indent);
    ...
    println!(
        "{}  \"num_data_points\": {},",
        indent, field.grid.num_data_points
    );
    ...
    println!(
        "{}  \"scanning_mode\": {},",
        indent, field.grid.scanning_mode
    );
    println!(
        "{}  \"resolution_flags\": {},",
        indent, field.grid.resolution_flags
    );
    println!(
        "{}  \"shape_of_earth\": {},",
        indent, field.grid.shape_of_earth
    );
    println!(
        "{}  \"projection\": \"{}\"",
        indent,
        format!("{:?}", field.grid.projection)
    );
    println!("{}}},", indent);
    ...
    println!(
        "{}  \"reference_value\": {},",
        indent, field.packing.reference_value
    );
    println!(
        "{}  \"binary_scale_factor\": {},",
        indent, field.packing.binary_scale_factor
    );
    println!(
        "{}  \"decimal_scale_factor\": {},",
        indent, field.packing.decimal_scale_factor
    );
    println!(
        "{}  \"bits_per_value\": {},",
        indent, field.packing.bits_per_value
    );
    println!(
        "{}  \"original_field_type\": {},",
        indent, field.packing.original_field_type
    );
    println!(
        "{}  \"quantization_step\": {},",
        indent,
        field.packing.quantization_step()
    );
